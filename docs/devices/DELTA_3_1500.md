...
- Battery Charging State (`bms_emsStatus.sysChgDsgState`)
...
- Grid Bypass (`pd.reserved` -> `{"moduleType": 1, "operateType": "bypassBan", "params": {"banBypassEn": "VALUE"}}`)
...
- AC Charging Power (`mppt.cfgChgWatts` -> `{"moduleType": 5, "operateType": "acChgCfg", "params": {"chgWatts": "VALUE", "chgPauseFlag": 255}}` [200 - 1500])
