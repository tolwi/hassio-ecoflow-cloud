...
- AC In Power (`powGetAcIn`) (energy:  _[Device Name]_ AC In  Energy)
- AC Out Power (`powGetAcOut`) (energy:  _[Device Name]_ AC Out  Energy)
- AC In Volts (`plugInInfoAcInVol`)
- AC Out Volts (`plugInInfoAcOutVol`)
- Solar In Power (`powGetPv`) (energy:  _[Device Name]_ Solar In  Energy)
