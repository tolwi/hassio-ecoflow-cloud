...
- USB Enabled (`cfg_usb_open` -> `{"Delta3SendHeaderMsg": {"msg": [{"pdata": {"Delta3SetCommand": {"cfg_usb_open": 1}}, "src": 32, "dest": 2, "d_src": 1, "d_dest": 1, "cmd_func": 254, "cmd_id": 17, "data_len": 3, "need_ack": 1, "product_id": 1, "version": 19, "payload_ver": 1, "device_sn": "SN"}]}}`)
...
- Grid Bypass (`ban_bypass_en` -> `{"Delta3SendHeaderMsg": {"msg": [{"pdata": {"Delta3SetCommand": {"ban_bypass_en": 6666}}, "src": 32, "dest": 2, "d_src": 1, "d_dest": 1, "cmd_func": 254, "cmd_id": 17, "data_len": 4, "need_ack": 1, "product_id": 1, "version": 19, "payload_ver": 1, "device_sn": "SN"}]}}`)
...
- AC Charging Power (`plug_in_info_ac_in_chg_pow_max` -> `{"Delta3SendHeaderMsg": {"msg": [{"pdata": {"Delta3SetCommand": {}}, "src": 32, "dest": 2, "d_src": 1, "d_dest": 1, "cmd_func": 254, "cmd_id": 17, "data_len": 7, "need_ack": 1, "product_id": 1, "version": 19, "payload_ver": 1, "device_sn": "SN"}]}}` [100 - 1500])
...
- Backup Reserve SOC (`backup_reverse_soc` -> `{"Delta3SendHeaderMsg": {"msg": [{"pdata": {"Delta3SetCommand": {"backup_reverse_soc": 6666}}, "src": 32, "dest": 2, "d_src": 1, "d_dest": 1, "cmd_func": 254, "cmd_id": 17, "data_len": 4, "need_ack": 1, "product_id": 1, "version": 19, "payload_ver": 1, "device_sn": "SN"}]}}` [5 - 100])
...
- Energy Strategy (`energy_strategy_mode` -> `{"Delta3SendHeaderMsg": {"msg": [{"pdata": {"Delta3SetCommand": {"energy_strategy_operate_mode": {"operate_self_powered_open": 0, "operate_scheduled_open": 0, "operate_tou_mode_open": 0}}}, "src": 32, "dest": 2, "d_src": 1, "d_dest": 1, "cmd_func": 254, "cmd_id": 17, "data_len": 9, "need_ack": 1, "product_id": 1, "version": 19, "payload_ver": 1, "device_sn": "SN"}]}}` [Standard (0), Self-Powered (1), Scheduled (2), TOU (3)])
- AC Charging Mode (`plug_in_info_ac_in_chg_mode` -> `{"Delta3SendHeaderMsg": {"msg": [{"pdata": {"Delta3SetCommand": {"plug_in_info_ac_in_chg_mode": 6666}}, "src": 32, "dest": 2, "d_src": 1, "d_dest": 1, "cmd_func": 254, "cmd_id": 17, "data_len": 4, "need_ack": 1, "product_id": 1, "version": 19, "payload_ver": 1, "device_sn": "SN"}]}}` [Auto (1), Silent (2), Custom (0)])
