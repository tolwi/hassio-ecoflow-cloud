...
STREAM_HISTORY_BATTERY_CHARGE_TODAY = "Battery Charge (Today)"
...
STREAM_HISTORY_ELECTRICITY_CONSUMPTION_TODAY = "Electricity Consumption (Today)"
STREAM_HISTORY_ENERGY_INDEPENDENCE_TODAY = "Energy Independence (Today)"
...
STREAM_HISTORY_ENVIRONMENTAL_IMPACT_TODAY = "Environmental Impact (Today)"
STREAM_HISTORY_GRID_EXPORT_CUMULATIVE = "Grid Export (Cumulative)"
STREAM_HISTORY_GRID_EXPORT_TODAY = "Grid Export (Today)"
STREAM_HISTORY_GRID_IMPORT_CUMULATIVE = "Grid Import (Cumulative)"
STREAM_HISTORY_GRID_IMPORT_TODAY = "Grid Import (Today)"
STREAM_HISTORY_SOLAR_GENERATED_CUMULATIVE = "Solar-Generated Energy (Cumulative)"
STREAM_HISTORY_SOLAR_GENERATED_TODAY = "Solar-Generated Energy (Today)"
STREAM_HISTORY_TOTAL_SOLAR_SAVINGS_CUMULATIVE = "Solar Energy Savings (Cumulative)"
STREAM_HISTORY_TOTAL_SOLAR_SAVINGS_TODAY = "Solar Energy Savings (Today)"
