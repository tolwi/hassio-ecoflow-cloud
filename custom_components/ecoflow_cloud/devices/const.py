...
STREAM_IN_POWER = "Total Input Power"
STREAM_STR_IN_POWER = "Total Input Power %s"
STREAM_OUT_POWER = "Total Output Power"
STREAM_STR_OUT_POWER = "Total Output Power %s"
...
STREAM_HISTORY_ENERGY_INDEPENDENCE_DAILY = "Energy Independence (Yesterday)"
STREAM_HISTORY_ENERGY_INDEPENDENCE_DAILY_TODAY = "Energy Independence (Today)"
STREAM_HISTORY_ENERGY_INDEPENDENCE_WEEKLY = "Energy Independence (Weekly)"
STREAM_HISTORY_ENERGY_INDEPENDENCE_MONTHLY = "Energy Independence (Monthly)"
STREAM_HISTORY_ENERGY_INDEPENDENCE_YEARLY = "Energy Independence (Yearly)"
STREAM_HISTORY_ENVIRONMENTAL_IMPACT = "Environmental Impact"
STREAM_HISTORY_ENVIRONMENTAL_IMPACT_CUMULATIVE = "Environmental Impact (Cumulative)"
STREAM_HISTORY_ENVIRONMENTAL_IMPACT_DAILY_TODAY = "Environmental Impact (Today)"
STREAM_HISTORY_TOTAL_SOLAR_SAVINGS = "Solar Energy Savings (Today)"
STREAM_HISTORY_TOTAL_SOLAR_SAVINGS_DAILY_TODAY = "Solar Energy Savings (Today)"
STREAM_HISTORY_TOTAL_SOLAR_SAVINGS_CUMULATIVE = "Solar Energy Savings (Cumulative)"
STREAM_HISTORY_SOLAR_GENERATED = "Solar-Generated Energy"
STREAM_HISTORY_SOLAR_GENERATED_CUMULATIVE = "Solar-Generated Energy (Cumulative)"
STREAM_HISTORY_SOLAR_GENERATED_DAILY_TODAY = "Solar-Generated Energy (Today)"
STREAM_HISTORY_ELECTRICITY_CONSUMPTION = "Electricity Consumption"
STREAM_HISTORY_ELECTRICITY_CONSUMPTION_DAILY_TODAY = "Electricity Consumption (Today)"
STREAM_HISTORY_ELECTRICITY_CONSUMPTION_CUMULATIVE = "Electricity Consumption (Cumulative)"
STREAM_HISTORY_GRID_IMPORT = "Grid Import (Today)"
STREAM_HISTORY_GRID_EXPORT = "Grid Export (Today)"
STREAM_HISTORY_BATTERY_CHARGE = "Battery Charge (Today)"
STREAM_HISTORY_BATTERY_DISCHARGE = "Battery Discharge (Today)"
STREAM_HISTORY_GRID_IMPORT_CUMULATIVE = "Grid Import (Cumulative)"
STREAM_HISTORY_GRID_EXPORT_CUMULATIVE = "Grid Export (Cumulative)"
STREAM_HISTORY_BATTERY_CHARGE_CUMULATIVE = "Battery Charge (Cumulative)"
STREAM_HISTORY_BATTERY_DISCHARGE_CUMULATIVE = "Battery Discharge (Cumulative)"

ACCU_CHARGE_CAP = "Capacity Charge (Cumulative)"
ACCU_CHARGE_ENERGY = "Energy Charge (Cumulative)"
ACCU_DISCHARGE_CAP = "Capacity Discharge (Cumulative)"
ACCU_DISCHARGE_ENERGY = "Energy Discharge (Cumulative)"

SLAVE_N_ACCU_CHARGE_CAP = "Slave %i Capacity Charge (Cumulative)"
SLAVE_N_ACCU_CHARGE_ENERGY = "Slave %i Energy Charge (Cumulative)"
SLAVE_N_ACCU_DISCHARGE_CAP = "Slave %i Capacity Discharge (Cumulative)"
