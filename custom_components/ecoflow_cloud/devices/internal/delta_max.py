...
class DeltaMax(BaseInternalDevice):
    ...
    def numbers(self, client: EcoflowApiClient) -> list[NumberEntity]:
        return [
            MaxBatteryLevelEntity(
                ...
                50,
                100,
                lambda value: {"moduleType": 2, "operateType": "TCP", "params": {"id": 49, "maxChgSoc": value}},
            ),
            MinBatteryLevelEntity(
                client,
                self,
                ...
                0,
                30,
                lambda value: {"moduleType": 2, "operateType": "TCP", "params": {"id": 51, "minDsgSoc": value}},
            ),
            MinGenStartLevelEntity(
                client,
                self,
                ...
                0,
                30,
                lambda value: {"moduleType": 2, "operateType": "TCP", "params": {"id": 52, "openOilSoc": value}},
            ),
            MaxGenStopLevelEntity(
                client,
                self,
                ...
                50,
                100,
                lambda value: {"moduleType": 2, "operateType": "TCP", "params": {"id": 53, "closeOilSoc": value}},
            ),
            ChargingPowerEntity(
                client,
                self,
