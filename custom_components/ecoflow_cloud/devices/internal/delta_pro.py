...
class DeltaPro(BaseInternalDevice):
    ...
    def numbers(self, client: EcoflowApiClient) -> list[NumberEntity]:
        return [
            MaxBatteryLevelEntity(
                ...
                50,
                100,
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 49, "maxChgSoc": value}},
            ),
            MinBatteryLevelEntity(
                client,
                self,
                ...
                0,
                30,
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 51, "minDsgSoc": value}},
            ),
            MaxBatteryLevelEntity(
                client,
                self,
            ...
            MinGenStartLevelEntity(
                ...
                0,
                30,
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"openOilSoc": value, "id": 52}},
            ),
            MaxGenStopLevelEntity(
                client,
                self,
                ...
                50,
                100,
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"closeOilSoc": value, "id": 53}},
            ),
            ChargingPowerEntity(
                client,
                self,
                ...
                200,
                2900,
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"slowChgPower": value, "id": 69}},
            ),
        ]
    ...
    def switches(self, client: EcoflowApiClient) -> list[SwitchEntity]:
        return [
            ...
            EnabledEntity(
                ...
                "mppt.carState",
                const.DC_ENABLED,
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 81, "enabled": value}},
            ),
            EnabledEntity(
                client,
                self,
            ...
            EnabledEntity(
                ...
                lambda value, params: {
                    "moduleType": 0,
                    "operateType": "TCP",
                    "params": {"id": 94, "isConfig": value, "bpPowerSoc": value * 50, "minDsgSoc": 0, "maxChgSoc": 0},
                },
            ),
        ]
    ...
    def selects(self, client: EcoflowApiClient) -> list[SelectEntity]:
        return [
            DictSelectEntity(
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"currMa": value, "id": 71}},
            ),
            TimeoutDictSelectEntity(
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"lcdTime": value, "id": 39}},
            ),
            TimeoutDictSelectEntity(
                client,
                self,
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"standByMode": value, "id": 33}},
            ),
            TimeoutDictSelectEntity(
                client,
                self,
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"standByMins": value, "id": 153}},
            ),
        ]
