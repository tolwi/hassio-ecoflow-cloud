...
from custom_components.ecoflow_cloud.sensor import LevelSensorEntity, WattsDifferenceSensorEntity, WattsSensorEntity, RemainSensorEntity, TempSensorEntity, \
    CyclesSensorEntity, \
