...
class Delta3CommandMessage(PrivateAPIMessageProtocol):
    ...
    def __init__(
        self,
        payload: delta3_pb2.River3SetCommand,
        packet: delta3_pb2.River3SendHeaderMsg,
    ):
        self._packet = packet
...
class Delta3(BaseInternalDevice):
    ...
    def selects(self, client: EcoflowApiClient) -> list[SelectEntity]:
        ...
        return [
            ...
            DictSelectEntity(
                ...
                lambda value: _create_delta3_proto_command("pv_chg_type", int(value), device.device_data.sn),
            ),
            TimeoutDictSelectEntity(
                client,
                self,
    ...
    def _decode_header_message(self, raw_data: bytes) -> dict[str, Any] | None:
        ...
        try:
            ...
            try:
                header_msg = delta3_pb2.River3HeaderMessage()
    ...
    def _decode_message_by_type(self, pdata: bytes, header_info: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            if cmd_func == 254 and cmd_id == 21:
                msg_display_upload = delta3_pb2.River3DisplayPropertyUpload()
                ...
                try:
                    msg_set_reply = delta3_pb2.River3SetReply()
                ...
                try:
                    msg_cms_heartbeat = delta3_pb2.River3CMSHeartBeatReport()
                ...
                try:
                    msg_bms_heartbeat = delta3_pb2.River3BMSHeartBeatReport()
        ...
        for item in list_info:
            ...
            if stat_obj is not None and stat_content is not None:
                if isinstance(stat_obj, str) and stat_obj.startswith("STATISTICS_OBJECT_"):
                    ...
                    try:
                        enum_name = delta3_pb2.River3StatisticsObject.Name(stat_obj)
            ...
            if header_msg.header:
                ...
                if pdata:
                    try:
                        ...
                        reply_msg = delta3_pb2.River3SetReply()
