...
class PowerPack(_message.Message):
    ...
    def __init__(self, sys_seq: _Optional[int] = ..., sys_power_stream: _Optional[_Iterable[_Union[PowerItem, _Mapping]]] = ...) -> None: ...
...
class NodeMassage(_message.Message):
    __slots__ = ("sn", "mac")
...
class MeshChildNodeInfo(_message.Message):
    ...
    parent_mac_id: bytes
    mesh_id: bytes
    sub_device_list: _containers.RepeatedCompositeFieldContainer[NodeMassage]
    def __init__(self, topology_type: _Optional[int] = ..., mesh_protocol: _Optional[int] = ..., max_sub_device_num: _Optional[int] = ..., parent_mac_id: _Optional[bytes] = ..., mesh_id: _Optional[bytes] = ..., sub_device_list: _Optional[_Iterable[_Union[NodeMassage, _Mapping]]] = ...) -> None: ...

class PrivateAPIGenericSetValue(_message.Message):
    __slots__ = ("value",)
...
class EnergyTotalReport(_message.Message):
    __slots__ = ("watth_seq", "watth_item")
    WATTH_SEQ_FIELD_NUMBER: _ClassVar[int]
    WATTH_ITEM_FIELD_NUMBER: _ClassVar[int]
    watth_seq: int
    watth_item: EnergyItem
    def __init__(self, watth_seq: _Optional[int] = ..., watth_item: _Optional[_Union[EnergyItem, _Mapping]] = ...) -> None: ...

class BatchEnergyTotalReport(_message.Message):
    __slots__ = ("watth_seq", "watth_item")
    WATTH_SEQ_FIELD_NUMBER: _ClassVar[int]
    WATTH_ITEM_FIELD_NUMBER: _ClassVar[int]
    watth_seq: int
    watth_item: _containers.RepeatedCompositeFieldContainer[EnergyItem]
    def __init__(self, watth_seq: _Optional[int] = ..., watth_item: _Optional[_Iterable[_Union[EnergyItem, _Mapping]]] = ...) -> None: ...

class EnergyTotalReportAck(_message.Message):
...
class country_town_message(_message.Message):
