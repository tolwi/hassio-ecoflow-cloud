...
class Delta3SetCommand(_message.Message):
    __slots__ = ("cfg_power_off", "cfg_utc_time", "cfg_utc_timezone", "en_beep", "ac_standby_time", "dc_standby_time", "screen_off_time", "dev_standby_time", "lcd_light", "cfg_dc12v_out_open", "cfg_usb_open", "xboost_en", "ban_bypass_en", "cms_max_chg_soc", "cms_min_dsg_soc", "cfg_energy_backup", "plug_in_info_ac_in_chg_pow_max", "cfg_ac_out_open", "plug_in_info_pv_dc_amp_max", "cfg_led_mode", "pv_chg_type", "backup_reverse_soc", "energy_strategy_operate_mode", "plug_in_info_ac_in_chg_mode", "output_power_off_memory")
...
class Delta3CfgEnergyStrategyOperateMode(_message.Message):
    __slots__ = ("operate_self_powered_open", "operate_scheduled_open", "operate_tou_mode_open")
    ...
    def __init__(self, operate_self_powered_open: _Optional[int] = ..., operate_scheduled_open: _Optional[int] = ..., operate_tou_mode_open: _Optional[int] = ...) -> None: ...
...
class Delta3CMSHeartBeatReport(_message.Message):
    ...
    def __init__(self, msg32_2_1: _Optional[_Union[Delta3CMSStatus1, _Mapping]] = ..., msg32_2_2: _Optional[_Union[Delta3CMSStatus2, _Mapping]] = ...) -> None: ...
...
class Delta3HeaderMessage(_message.Message):
    ...
    def __init__(self, header: _Optional[_Iterable[_Union[Delta3Header, _Mapping]]] = ...) -> None: ...
