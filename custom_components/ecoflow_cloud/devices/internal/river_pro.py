...
class RiverPro(BaseInternalDevice):
    ...
    def switches(self, client: EcoflowApiClient) -> list[SwitchEntity]:
        return [
            ...
            EnabledEntity(
                ...
                "pd.carSwitch",
                const.DC_ENABLED,
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 34, "enabled": value}},
            ),
            EnabledEntity(
                client,
                self,
            ...
            EnabledEntity(
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 65, "workMode": value}},
            ),
            EnabledEntity(
                client,
                self,
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 73, "fanMode": value}},
            ),
        ]
    ...
    def selects(self, client: EcoflowApiClient) -> list[SelectEntity]:
        return [
            TimeoutDictSelectEntity(
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 33, "standByMode": value}},
            ),
            TimeoutDictSelectEntity(
                client,
                self,
            ...
            TimeoutDictSelectEntity(
                ...
                lambda value: {"moduleType": 0, "operateType": "TCP", "params": {"id": 153, "standByMins": value}},
            ),
