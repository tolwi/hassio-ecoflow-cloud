...
class Delta2Max(BaseInternalDevice):
    def sensors(self, client: EcoflowApiClient) -> list[SensorEntity]:
        return [
            ...
            CumulativeCapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveInfo_1.accuChgCap", const.SLAVE_N_ACCU_CHARGE_CAP % 1, False, True
            ),
            EnergySensorEntity(
                client, self, "bms_slave_bmsSlaveInfo_1.accuChgEnergy", const.SLAVE_N_ACCU_CHARGE_ENERGY % 1, False
            ),
            CumulativeCapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveInfo_1.accuDsgCap", const.SLAVE_N_ACCU_DISCHARGE_CAP % 1, False, True
            ),
            EnergySensorEntity(
                client, self, "bms_slave_bmsSlaveInfo_1.accuDsgEnergy", const.SLAVE_N_ACCU_DISCHARGE_ENERGY % 1, False
            ),
            LevelSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.soc", const.SLAVE_N_BATTERY_LEVEL % 1, False, True
            )
            ...
            CapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.designCap", const.SLAVE_N_DESIGN_CAPACITY % 1, False
            ),
            CapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.fullCap", const.SLAVE_N_FULL_CAPACITY % 1, False
            ),
            CapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.remainCap", const.SLAVE_N_REMAIN_CAPACITY % 1, False
            ),
            TempSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.temp", const.SLAVE_N_BATTERY_TEMP % 1, False, True
            )
            ...
            TempSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.minCellTemp", const.SLAVE_N_MIN_CELL_TEMP % 1, False
            ),
            TempSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.maxCellTemp", const.SLAVE_N_MAX_CELL_TEMP % 1, False
            ),
            ...
            MilliVoltSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.minCellVol", const.SLAVE_N_MIN_CELL_VOLT % 1, False
            ),
            MilliVoltSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.maxCellVol", const.SLAVE_N_MAX_CELL_VOLT % 1, False
            ),
            CyclesSensorEntity(
            ...
            OutWattsSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.outputWatts", const.SLAVE_N_OUT_POWER % 1, False, True
            ),
            LevelSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_1.f32ShowSoc", const.SLAVE_N_BATTERY_LEVEL_SOC % 1, False, True
            ),
            # Optional Slave 2 Battery
            CumulativeCapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveInfo_2.accuChgCap", const.SLAVE_N_ACCU_CHARGE_CAP % 2, False
            ),
            EnergySensorEntity(
                client,
                self,
            ...
            CumulativeCapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveInfo_2.accuDsgCap", const.SLAVE_N_ACCU_DISCHARGE_CAP % 2, False
            ),
            EnergySensorEntity(
                client,
                self,
            ...
            LevelSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.soc", const.SLAVE_N_BATTERY_LEVEL % 2, False, True
            )
            ...
            CapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.designCap", const.SLAVE_N_DESIGN_CAPACITY % 2, False
            ),
            CapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.fullCap", const.SLAVE_N_FULL_CAPACITY % 2, False
            ),
            CapacitySensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.remainCap", const.SLAVE_N_REMAIN_CAPACITY % 2, False
            ),
            TempSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.temp", const.SLAVE_N_BATTERY_TEMP % 2, False, True
            )
            ...
            TempSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.minCellTemp", const.SLAVE_N_MIN_CELL_TEMP % 2, False
            ),
            TempSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.maxCellTemp", const.SLAVE_N_MAX_CELL_TEMP % 2, False
            ),
            ...
            MilliVoltSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.minCellVol", const.SLAVE_N_MIN_CELL_VOLT % 2, False
            ),
            MilliVoltSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.maxCellVol", const.SLAVE_N_MAX_CELL_VOLT % 2, False
            ),
            CyclesSensorEntity(
            ...
            OutWattsSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.outputWatts", const.SLAVE_N_OUT_POWER % 2, False, True
            ),
            LevelSensorEntity(
                client, self, "bms_slave_bmsSlaveStatus_2.f32ShowSoc", const.SLAVE_N_BATTERY_LEVEL_SOC % 2, False, True
            ),
        ...
        return [
            ...
            ChargingPowerEntity(
                ...
                lambda value: {
                    ...
                    "moduleSn": self.device_info.sn,
                    "params": {"slowChgWatts": int(value), "fastChgWatts": 2000, "chgPauseFlag": 0},
                },
            ),
        ]
